...
@register_model("wav2vec_baseline2", dataclass=Wav2Vec2CtcConfig)
...
class TransformerSentenceDncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.W4 = nn.Linear(self.embedding_dim, self.embedding_dim)
    ...
    def forward(
        ...
        _g = F.sigmoid(self.W3(x) + self.W4(attn))
