...
@register_criterion("mil", dataclass=CtcCriterionConfig)
class MILCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        net_output = model(**sample["net_input"], text=sample['text'], text_mask=sample['text_mask'],text_lengths=sample['text_lengths'])
